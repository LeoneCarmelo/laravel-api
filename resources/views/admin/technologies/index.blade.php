...
<div class="container pt-3">
    ...
    <form action="{{route('admin.technologies.store')}}" method="post" class="d-flex">
        ...
        <div class="input-group mb-3 w-25 mx-auto py-3">
            <input type="text" class="form-control" placeholder="Insert link image" aria-label="Button" name="link_img" id="link_img">
        </div>
        <div class="input-group mb-3 w-25 mx-auto py-3">
    ...
    <div class="row row-cols-1 row-col-sm-2 row-cols-md-4">
        ...
        <div class="col d-flex justify-content-center pb-4">
            <img width="180px" src="{{asset($technology->link_img)}}" alt="{{$technology->name}}" class="img-fluid" />
        </div>
        @endforeach
    </div>
</div>
